...
function Login() {
	...
	const postLogin = async () => {
		...
		fetch('https://infinitysport.site/login', requestOptions)
				...
				<div>
					...
					<div className='flex flex-col xl:flex-row min-h-screen w-screen'>
						<div className='xl:basis-1/2 relative h-[20vh] xl:h-screen'>
							<Image src='http://source.unsplash.com/74tlEYKgrBE' alt='shit' layout='fill' objectFit='cover' objectPosition='center' />
						</div>
